 ...
 *
 */
public class ScrowViewContainer extends RelativeLayout {
    ...
    public ScrowViewContainer(Context context) {
        super(context);
        init();
    }

    public ScrowViewContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ScrowViewContainer(Context context, AttributeSet attrs, int defStyle) {
