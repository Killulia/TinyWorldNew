...
public class RecordAdapter extends BaseAdapter {
    ...
    public RecordAdapter(Context context, List<Goods> goodses ) {
    ...
    static class CollectHolder{
        ...
        public CollectHolder(View rootView) {
            Img = (ImageView) rootView.findViewById(R.id.item_record_img);
            name = (TextView) rootView.findViewById(R.id.item_record_name);
            price = (TextView) rootView.findViewById(R.id.item_record_price);
            discount = (TextView) rootView.findViewById(R.id.item_record_discount_price);
            style = (TextView) rootView.findViewById(R.id.tv_color_size2);
        }
    }
